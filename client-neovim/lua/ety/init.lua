...
-- No custom handlers -- push diagnostics and hover come from Neovim's built-in
-- LSP client against the server's advertised capabilities (incl. the Milestone
-- 9 base-type completion, negotiated server-side).
